...
public final class AlarmStateManager extends BroadcastReceiver {
    ...
    public static void setDismissState(Context context, AlarmInstance instance) {
        ...
        if (isPowerOffAlarm(context)) {
            try {
                Intent intent = new Intent(ACTION_POWER_ON_ALERT);
    ...
    public static boolean getPowerUpAlarmPref(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        return prefs.getBoolean(FIRST_ALARM_FLAG, false);
    }

    public static void setPowerUpAlarmPref(Context context, boolean isRtcPowerUp) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
    ...
    public static boolean isPowerOffAlarm(Context context) {
        boolean isPoAlarm = getPowerUpAlarmPref(context);
        if (isPoAlarm) {
            setPowerUpAlarmPref(context, false);
        }
        return isPoAlarm;
    }
}
